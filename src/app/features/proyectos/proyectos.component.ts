...
export class ProyectosComponent {
  readonly projects: ProjectCard[] = [
    ...
    },
    {
      ...
      description:
        'Sistema de gestión y registro de empleados que centraliza la información del personal. Ofrece autenticación segura y una interfaz intuitiva para administrar datos de empleados de manera eficiente.',
      imageUrl:
        'https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&q=80&w=800&h=500',
      imageAlt: 'Captura de pantalla de la aplicación Registro de Empleados',
      liveUrl: 'https://registro-empleados-front.vercel.app/login',
      tags: [
        {
          label: 'Angular',
          icon: 'ph ph-angular-logo',
      ...
      features: [
        { label: 'Autenticación Segura', icon: 'ph ph-lock', iconColor: 'text-green-400' },
        { label: 'CRUD de Empleados', icon: 'ph ph-users', iconColor: 'text-blue-400' },
        { label: 'Interfaz Moderna', icon: 'ph ph-desktop', iconColor: 'text-pink-400' },
      ],
    },
  ];
}
